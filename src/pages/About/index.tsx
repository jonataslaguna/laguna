        ...
        <div className={styles.about}>
          <div>
            ...
            <p>
              ...
              Atualmente, decidi focar e me dedicar exclusivamente a isso, que é, o que realmente nasci para fazer. Estou imerso no estudo de desenvolvimento web full stack na <a href="https://www.betrybe.com/" target="_blank">Trybe</a>. Concluí minha formação em front-end, e agora estou envolvido no estudo aprofundado do back-end, enquanto continuo a aprimorar minhas habilidades já adquiridas. Aqui, você encontrará alguns dos meus projetos que representam minha jornada de aprendizado e meu compromisso com o aprimoramento constante.<br/>
